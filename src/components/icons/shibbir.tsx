...
// The signature wordmark geometry, shared by this icon and by the footer's
// BinaryReveal (which uses the same path as a letterform mask), so the two stay
// in lockstep and the path is defined once.
export const SIGNATURE_VIEW_BOX = '0 0 588.6 82.601';
...
export default function Shibbir({
    className,
    ...rest
    ...
    return (
        ...
        >
            <g
                ...
                fill="currentColor"
            >
                <path d={SIGNATURE_PATH_D} vectorEffect="non-scaling-stroke" />
            </g>
        </svg>
    );
}
