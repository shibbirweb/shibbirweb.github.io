...
/**
 * The original (classic) Firebase flame, sourced from Devicon (firebase-plain).
 * Rendered as a single currentColor silhouette so it blooms to the Firebase
 * amber on hover like the other brand tiles.
 */
